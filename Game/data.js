...
const ROOMS = {
  ...
  CREW_QUARTERS:    { id:'CREW_QUARTERS',    name:'Crew Quarters',         icon:'🛏️', x:-1220, y:-160,  w:440, h:320, empty:false, start:true },
  MEDICAL_BAY:      { id:'MEDICAL_BAY',      name:'Medical Bay',           icon:'🏥', x:-1220, y:-660,  w:440, h:320, empty:false },
  DERELICT_QUARTERS:{ id:'DERELICT_QUARTERS',name:'Derelict Quarters',     icon:'🌑', x:-1220, y:340,   w:440, h:320, empty:true  },
  CAFETERIA:        { id:'CAFETERIA',        name:'Cafeteria',             icon:'🍽️', x:780,   y:-160,  w:440, h:320, empty:false },
  BIO_LAB:          { id:'BIO_LAB',          name:'Bio Lab',               icon:'🧪', x:780,   y:340,   w:440, h:320, empty:false },
  CONTROL_ROOM:     { id:'CONTROL_ROOM',     name:'Control Room',          icon:'💻', x:780,   y:-660,  w:440, h:320, empty:false },
  AI_CORE:          { id:'AI_CORE',          name:'AI Core',               icon:'🤖', x:780,   y:-1160, w:440, h:320, empty:false },
  OBSERVATION_DECK: { id:'OBSERVATION_DECK', name:'Observation Deck',      icon:'🔭', x:1430,  y:-160,  w:440, h:320, empty:false },
  STORAGE:          { id:'STORAGE',          name:'Storage',               icon:'📦', x:-220,  y:-910,  w:440, h:320, empty:false },
  WORKSHOP:         { id:'WORKSHOP',         name:'Workshop',              icon:'🔧', x:-970,  y:-910,  w:440, h:320, empty:false },
  COMMS_HUB:        { id:'COMMS_HUB',        name:'Communications Hub',    icon:'📡', x:530,   y:-910,  w:440, h:320, empty:false },
  EMPTY_ANNEX:      { id:'EMPTY_ANNEX',      name:'Disused Annex',         icon:'🌑', x:-190,  y:-1500, w:380, h:300, empty:true  },
  HIDDEN_VAULT:     { id:'HIDDEN_VAULT',     name:'Hidden Vault',          icon:'❓', x:-970,  y:-1510, w:440, h:320, empty:false, secret:true },
  ENGINE_ROOM:      { id:'ENGINE_ROOM',      name:'Engine Room',           icon:'⚙️', x:-220,  y:640,   w:440, h:320, empty:false },
  POWER_REACTOR:    { id:'POWER_REACTOR',    name:'Power Reactor',         icon:'☢️', x:-220,  y:1140,  w:440, h:320, empty:false },
  AIRLOCK_DOCKING:  { id:'AIRLOCK_DOCKING',  name:'Airlock & Docking Bay', icon:'🚀', x:280,   y:640,   w:440, h:320, empty:false },
};
...
const DOORS = [
  { id:'d1',  a:'CENTRAL_HALL', b:'CREW_QUARTERS',     gate:{x:-565, y:0},    corridor:{x:-780, y:-70,  w:430, h:140} },
  { id:'d2',  a:'CREW_QUARTERS',b:'MEDICAL_BAY',       gate:{x:-1000,y:-250}, corridor:{x:-1070,y:-340, w:140, h:180} },
  { id:'d3',  a:'CREW_QUARTERS',b:'DERELICT_QUARTERS', gate:{x:-1000,y:250},  corridor:{x:-1070,y:160,  w:140, h:180} },
  { id:'d4',  a:'CENTRAL_HALL', b:'CAFETERIA',         gate:{x:565,  y:0},    corridor:{x:350,  y:-70,  w:430, h:140} },
  { id:'d5',  a:'CAFETERIA',    b:'BIO_LAB',           gate:{x:1000, y:250},  corridor:{x:930,  y:160,  w:140, h:180} },
  { id:'d6',  a:'CAFETERIA',    b:'CONTROL_ROOM',      gate:{x:1000, y:-250}, corridor:{x:930,  y:-340, w:140, h:180},
              locked:true, requires:{item:'ID_CARD'} },
  { id:'d7',  a:'CONTROL_ROOM', b:'AI_CORE',           gate:{x:1000, y:-750}, corridor:{x:930,  y:-840, w:140, h:180},
              locked:true, requires:{item:'DATA_DRIVE', step:9} },
  { id:'d8',  a:'CAFETERIA',    b:'OBSERVATION_DECK',  gate:{x:1325, y:0},    corridor:{x:1220, y:-70,  w:210, h:140} },
  { id:'d9',  a:'CENTRAL_HALL', b:'STORAGE',           gate:{x:0,    y:-445}, corridor:{x:-70,  y:-590, w:140, h:290} },
  { id:'d10', a:'STORAGE',      b:'WORKSHOP',          gate:{x:-375, y:-750}, corridor:{x:-530, y:-820, w:310, h:140} },
  { id:'d11', a:'STORAGE',      b:'COMMS_HUB',         gate:{x:375,  y:-750}, corridor:{x:220,  y:-820, w:310, h:140} },
  { id:'d12', a:'STORAGE',      b:'EMPTY_ANNEX',       gate:{x:0,    y:-1055},corridor:{x:-70,  y:-1200,w:140, h:290} },
  { id:'d13', a:'WORKSHOP',     b:'HIDDEN_VAULT',      gate:{x:-750, y:-1050},corridor:{x:-1040,y:-1190,w:140, h:280},
              locked:true, secret:true, requires:{flag:'vaultUnlocked'} },
  { id:'d14', a:'CENTRAL_HALL', b:'ENGINE_ROOM',       gate:{x:0,    y:470},  corridor:{x:-70,  y:300,  w:140, h:340} },
  { id:'d15', a:'ENGINE_ROOM',  b:'POWER_REACTOR',     gate:{x:0,    y:1050}, corridor:{x:-70,  y:960,  w:140, h:180} },
  { id:'d16', a:'ENGINE_ROOM',  b:'AIRLOCK_DOCKING',   gate:{x:250,  y:800},  corridor:{x:220,  y:730,  w:60,  h:140} },
];
