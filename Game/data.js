...
CREW_QUARTERS:    { id:'CREW_QUARTERS',    name:'Crew Quarters',         icon:'🛏️', x:-900,  y:-150,  w:400, h:300, empty:false, start:true },
MEDICAL_BAY:      { id:'MEDICAL_BAY',      name:'Medical Bay',           icon:'🏥', x:-900,  y:-550,  w:400, h:300, empty:false },
DERELICT_QUARTERS:{ id:'DERELICT_QUARTERS',name:'Derelict Quarters',     icon:'🌑', x:-1400, y:-150,  w:400, h:300, empty:true  },
CAFETERIA:        { id:'CAFETERIA',        name:'Cafeteria',             icon:'🍽️', x:-900,  y:150,   w:400, h:300, empty:false },
...
AIRLOCK_DOCKING:  { id:'AIRLOCK_DOCKING',  name:'Airlock & Docking Bay', icon:'🚀', x:-200,  y:2050,  w:400, h:300, empty:false },
};
...
const DOORS = [
// === LEFT WING: LIVING QUARTERS ===
{ id:'d1',  a:'CENTRAL_HALL', b:'CREW_QUARTERS',     gate:{x:-350, y:0},    corridor:{x:-400, y:-80,  w:100, h:160} },
{ id:'d2',  a:'CREW_QUARTERS',b:'MEDICAL_BAY',       gate:{x:-700, y:-200}, corridor:{x:-780, y:-250, w:160, h:100} },
{ id:'d3',  a:'CREW_QUARTERS',b:'DERELICT_QUARTERS', gate:{x:-1100, y:0},   corridor:{x:-1150, y:-80, w:100, h:160} },
{ id:'d4',  a:'CENTRAL_HALL', b:'CAFETERIA',         gate:{x:-350, y:250},  corridor:{x:-400, y:170,  w:100, h:160} },

// === RIGHT WING: COMMAND & RESEARCH ===
{ id:'d5',  a:'CAFETERIA',    b:'BIO_LAB',           gate:{x:0, y:500},     corridor:{x:-900, y:420,  w:1700, h:160} }, // long cross-hall
...
{ id:'d8',  a:'CAFETERIA',    b:'OBSERVATION_DECK',  gate:{x:450, y:0},     corridor:{x:-400, y:-80,  w:1700, h:160} }, // glass corridor along outer rim

// === LOWER CORE: STORAGE & ENGINEERING ===
{ id:'d9',  a:'CENTRAL_HALL', b:'STORAGE',           gate:{x:-100, y:400},  corridor:{x:-180, y:250,  w:160, h:300} }, // vertical shaft
{ id:'d10', a:'STORAGE',      b:'WORKSHOP',          gate:{x:-250, y:700},  corridor:{x:-300, y:620,  w:100, h:160} },
{ id:'d11', a:'STORAGE',      b:'COMMS_HUB',         gate:{x:200, y:0},     corridor:{x:120, y:-250,  w:160, h:800} }, // tall comms riser
{ id:'d12', a:'STORAGE',      b:'EMPTY_ANNEX',       gate:{x:-50, y:950},   corridor:{x:-130, y:850,  w:160, h:200} }, // maintenance tunnel
...
{ id:'d14', a:'CENTRAL_HALL', b:'ENGINE_ROOM',       gate:{x:100, y:650},   corridor:{x:20, y:250,    w:160, h:800} }, // main engineering shaft
{ id:'d15', a:'ENGINE_ROOM',  b:'POWER_REACTOR',     gate:{x:0, y:1450},    corridor:{x:-80, y:1350,  w:160, h:200} },
{ id:'d16', a:'POWER_REACTOR',b:'AIRLOCK_DOCKING',   gate:{x:0, y:1950},    corridor:{x:-80, y:1850,  w:160, h:200} }, // final airlock chamber
];
